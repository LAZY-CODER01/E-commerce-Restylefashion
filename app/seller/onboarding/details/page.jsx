...
export default function SellerDetailsPage() {
  ...
  const isFilled = Object.entries(formData).every(([key, value]) => {
     if (key === 'line2') return true; // Landmark optional
     return value;
  });
        ...
        <div className="p-8 border-b border-gray-100 flex flex-col gap-6">
           ...
           <div className="flex flex-col gap-2">
              <div className="flex justify-between items-end mb-1">
                 <span className="text-[12px] font-bold text-brand-pink uppercase tracking-widest">Enterprise Info</span>
              ...
              <div className="w-full h-2 bg-brand-light rounded-full overflow-hidden">
                 <div className="w-1/2 h-full bg-brand-pink rounded-full transition-all duration-500" />
              </div>
           </div>
        </div>
